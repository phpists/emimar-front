  ...
  pdf: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
      <g>
        ...
        />
        <path
          d="M25,20.556A1.444,1.444,0,0,1,23.556,22H16l9-11Z"
          style={{ fill: "#ffcccb" }}
        />
        <text x="27" y="40" fill="#ffffff" fontSize="14" fontWeight="bold">
          PDF
        </text>
      </g>
    </svg>
  ...
  document: (
    ...
    url: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path fill="#0078d7"
                  d="M10.59 13.41a1.5 1.5 0 0 1 0-2.12l3.54-3.54a1.5 1.5 0 0 1 2.12 2.12L12.71 14a1.5 1.5 0 0 1-2.12 0z"/>
            <path fill="#0078d7"
                  d="M4.93 19.07a7.5 7.5 0 0 1 0-10.6l3.54-3.54a7.5 7.5 0 0 1 10.6 10.6l-3.54 3.54a7.5 7.5 0 0 1-10.6 0zm1.41-9.19a5.5 5.5 0 0 0 0 7.78 5.5 5.5 0 0 0 7.78 0l3.54-3.54a5.5 5.5 0 0 0-7.78-7.78z"/>
        </svg>
    ),
};
